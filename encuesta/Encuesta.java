...
public class Encuesta {
    ...
    // Método para mostrar información de una persona por posición
    ...
    public void main() {
        ...
        while (true) {
            ...
            if (opcion == 1) {
                ...
                for (int i = 0; i < 3; i++) {
                    System.out.print("ingresa tu cancion favorita " + (i + 1) + ": ");
                    String titulo = scanner.nextLine();
                    System.out.print("Ingrese el artista de la cancion " + (i + 1) + ": ");
